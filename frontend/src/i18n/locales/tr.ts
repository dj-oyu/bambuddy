export default {
  ...
  printers: {
    ...
    filamentSpoof: {
      badgeTitle: '{{slot}} bittiğinde otomatik olarak devreye girer',
      menuEngage: 'Bitiş yedeği ayarla',
      menuRelease: 'Bitiş yedeğini kaldır',
      modalTitle: 'Bitiş Yedeği',
      primaryLabel: '{{slot}} için yedek',
      modalHelp: 'Bu yuvadaki filament bittiğinde otomatik olarak devreye girecek makarayı seçin.',
      sameTypeOnly: 'Yalnızca aynı malzeme türündeki ({{type}}) makaralar devreye girebilir.',
      noCandidates: 'Uyumlu makara yok — yedek aynı malzeme türünde ({{type}}) olmalıdır.',
      confirm: 'Yedeği ayarla',
      toastEngaged: 'Bitiş yedeği ayarlandı',
      toastEngagedNative: 'Yedek etkinleştirildi — makaralar zaten eşleşiyor.',
      toastReleased: 'Bitiş yedeği kaldırıldı',
      toastFailed: 'Bitiş yedeği etkinleştirilemedi — yazıcı değişikliği kabul etmedi. Tekrar deneyin veya yazıcıyı yeniden başlatın.',
      kDiffWarning: 'Bu makaranın akış davranışı biraz farklı; geçiş sonrası baskı kalitesi değişebilir.',
      badgePending: '{{slot}} için bitiş yedeği etkinleştiriliyor…',
      reassignTitle: 'Yedek yeniden atansın mı?',
      reassignBody: 'Bu makara şu anda aynı renkte başka bir makarayı yedekliyor. Yeniden atansın mı?',
      reassignConfirm: 'Yeniden ata',
    },
    activeJobSlot: {
  ...
  settings: {
    ...
    gcodeTemplateInsert: 'Şablon ekle',
    gcodeTemplateOverwriteConfirm: 'Bu alandaki mevcut G-code\'un üzerine yazılacak. Devam edilsin mi?',
  ...
  gcodeMotion: {
    title: 'G-code Hareket Önizlemesi',
    previewButton: 'Hareketi önizle',
    play: 'Oynat',
    pause: 'Duraklat',
    scrubber: 'Zaman çizelgesi',
    speed: 'Hız',
    frontOverhang: 'Ön taşma',
    backOverhang: 'Arka taşma',
    corexyNoSwing: 'CoreXY: tabla ileri geri hareket etmez (yalnızca Z)',
    unknownGeometry: 'Geometri bilinmiyor — genel 256 mm yazıcı kullanılıyor',
    accelDisclaimer: 'Süreler ivmelenmeyi yok sayar; gerçek hareket daha yavaştır.',
  },
  libraryTrash: {
    title: 'Çöp Kutusu',
    headerButton: 'Çöp',
