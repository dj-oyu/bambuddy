export default {
  ...
  printers: {
    ...
    filamentSpoof: {
      badgeTitle: 'Subentra automaticamente quando {{slot}} si esaurisce',
      menuEngage: 'Imposta bobina di riserva',
      menuRelease: 'Rimuovi bobina di riserva',
      modalTitle: 'Bobina di riserva',
      primaryLabel: 'Riserva per {{slot}}',
      modalHelp: 'Scegli quale bobina subentra automaticamente quando questo slot si esaurisce.',
      sameTypeOnly: 'Solo bobine dello stesso tipo di materiale ({{type}}) possono subentrare.',
      noCandidates: 'Nessuna bobina compatibile — la riserva deve essere dello stesso tipo di materiale ({{type}}).',
      confirm: 'Imposta riserva',
      toastEngaged: 'Bobina di riserva impostata',
      toastEngagedNative: 'Riserva attivata — le bobine corrispondono già.',
      toastReleased: 'Bobina di riserva rimossa',
      toastFailed: 'Impossibile attivare la bobina di riserva — la stampante non ha accettato la modifica. Riprova o riavvia la stampante.',
      kDiffWarning: 'Il comportamento di flusso di questa bobina è leggermente diverso; la qualità di stampa potrebbe variare dopo il passaggio.',
      badgePending: 'Attivazione riserva per {{slot}}…',
      reassignTitle: 'Riassegnare la riserva?',
      reassignBody: 'Questa bobina fa attualmente da riserva a un\'altra bobina dello stesso colore. Riassegnarla?',
      reassignConfirm: 'Riassegna',
    },
    activeJobSlot: {
  ...
  settings: {
    ...
    gcodeTemplateInsert: 'Inserisci modello',
    gcodeTemplateOverwriteConfirm: 'Il G-code esistente in questo campo verrà sovrascritto. Continuare?',
  ...
  gcodeMotion: {
    title: 'Anteprima movimento G-code',
    previewButton: 'Anteprima movimento',
    play: 'Riproduci',
    pause: 'Pausa',
    scrubber: 'Linea temporale',
    speed: 'Velocità',
    frontOverhang: 'Sporgenza anteriore',
    backOverhang: 'Sporgenza posteriore',
    corexyNoSwing: 'CoreXY: il piano non oscilla (solo Z)',
    unknownGeometry: 'Geometria sconosciuta — stampante generica da 256 mm',
    accelDisclaimer: 'Le durate ignorano l\'accelerazione: il movimento reale è più lento.',
  },
  libraryTrash: {
    title: 'Cestino',
