export default {
  ...
  printers: {
    ...
    filamentSpoof: {
      badgeTitle: 'Übernimmt automatisch, wenn {{slot}} leer läuft',
      menuEngage: 'Auslauf-Backup festlegen',
      menuRelease: 'Auslauf-Backup entfernen',
      modalTitle: 'Auslauf-Backup',
      primaryLabel: 'Backup für {{slot}}',
      modalHelp: 'Wähle, welche Spule automatisch übernimmt, wenn dieser Slot leer läuft.',
      sameTypeOnly: 'Nur Spulen mit demselben Materialtyp ({{type}}) können übernehmen.',
      noCandidates: 'Keine kompatiblen Spulen — das Backup muss denselben Materialtyp ({{type}}) haben.',
      confirm: 'Backup festlegen',
      toastEngaged: 'Auslauf-Backup festgelegt',
      toastEngagedNative: 'Backup aktiviert — die Spulen stimmen bereits überein.',
      toastReleased: 'Auslauf-Backup entfernt',
      toastFailed: 'Auslauf-Backup konnte nicht aktiviert werden — der Drucker hat die Änderung nicht übernommen. Versuche es erneut oder starte den Drucker neu.',
      kDiffWarning: 'Das Fließverhalten dieser Spule weicht leicht ab; die Druckqualität kann sich nach dem Umschalten ändern.',
      badgePending: 'Auslauf-Backup für {{slot}} wird aktiviert…',
      reassignTitle: 'Backup neu zuweisen?',
      reassignBody: 'Diese Spule sichert derzeit eine andere Spule derselben Farbe ab. Neu zuweisen?',
      reassignConfirm: 'Neu zuweisen',
    },
    activeJobSlot: {
  ...
  queue: {
    ...
    badges: {
      ...
      unloadAtStart: 'Entlädt zu Beginn (Wechsel)',
      noUnloadAtStart: 'Keine Entladung zu Beginn',
      unloadAtEnd: 'Entlädt am Ende',
      unloadCarriedOver: 'Keine Endentladung (für nächsten Auftrag beibehalten)',
    },
    // Empty state
    empty: {
  ...
  settings: {
    ...
    bmcuLink: {
      infoTitle: 'BMCU-Link-Geräte',
      infoBody: 'BMCU-Link-Adapter registrieren sich beim Verbindungsaufbau automatisch. Dieser Bereich zeigt Verbindungszustand, letzten Status und aktuelle Telemetrieereignisse jedes Adapters.',
      disabled: 'BMCU Link ist auf diesem Server deaktiviert.',
      connectionTitle: 'Verbindungsendpunkte der Bridge',
      connectionBody: 'Konfigurieren Sie die Pi/Pico-Bridge mit einer dieser URLs. Sie verwenden die LAN-Adresse dieses Servers – die Adresse im Browser kann eine Tailscale-/VPN-Adresse sein, die die Bridge nicht erreichen kann.',
      connectionNoLan: 'Auf diesem Server wurde keine LAN-IPv4-Adresse erkannt.',
      connectionAuthOn: 'BMB1 verwendet einen bereitgestellten gerätespezifischen Schlüssel und HMAC-Authentifizierung auf der dedizierten TCP-Verbindung.',
      connectionAuthOff: 'Die Authentifizierung ist derzeit deaktiviert: Es ist kein Token erforderlich.',
      empty: 'Noch keine BMCU-Link-Geräte verbunden',
      linkState: {
        online: 'Online',
        stale: 'Veraltet',
        offline: 'Offline',
      ...
      mode: {
        production_monitor: 'Produktionsmonitor',
        bench_stub: 'Teststand-Simulation',
      },
      firmware: 'Firmware',
      protocol: 'Protokoll',
      lastSeen: 'Zuletzt gesehen',
      never: 'nie',
      envelopes: 'Nachrichten',
      dropped: '{{count}} verworfen',
      lastStatus: 'Letzter Status',
      statusChannel: 'Kanal',
      statusCurrent: 'aktiv',
      statusHardware: 'Lader vorhanden',
    ...
    gcodeTemplateInsert: 'Vorlage einfügen',
    gcodeTemplateOverwriteConfirm: 'Der vorhandene G-Code in diesem Feld wird überschrieben. Fortfahren?',
  ...
  printModal: {
    ...
    layerInspection: 'Erste-Schicht-Prüfung',
    timelapse: 'Zeitraffer',
    unloadEdit: 'Filamententladung',
    unloadEditAuto: 'Automatisch',
    unloadEditStart: 'Entladung zu Beginn erzwingen (abgesicherter Wechsel)',
    unloadEditEnd: 'Am Druckende entladen',
    unloadEditNone: 'Keine G-Code-Änderungen',
    cancel: 'Abbrechen',
  ...
  gcodeMotion: {
    title: 'G-Code-Bewegungsvorschau',
    previewButton: 'Bewegung anzeigen',
    play: 'Abspielen',
    pause: 'Pause',
    scrubber: 'Zeitleiste',
    speed: 'Geschwindigkeit',
    frontOverhang: 'Überstand vorne',
    backOverhang: 'Überstand hinten',
    corexyNoSwing: 'CoreXY: Bett schwingt nicht (nur Z)',
    unknownGeometry: 'Geometrie unbekannt — generischer 256-mm-Drucker wird verwendet',
    accelDisclaimer: 'Zeiten ignorieren die Beschleunigung, die reale Bewegung ist langsamer.',
  },
  libraryTrash: {
    title: 'Papierkorb',
