export default {
  ...
  printers: {
    ...
    filamentSpoof: {
      badgeTitle: 'Prend le relais automatiquement quand {{slot}} est épuisé',
      menuEngage: 'Définir la bobine de secours',
      menuRelease: 'Retirer la bobine de secours',
      modalTitle: 'Bobine de secours',
      primaryLabel: 'Secours pour {{slot}}',
      modalHelp: 'Choisissez quelle bobine prend le relais automatiquement quand cet emplacement est épuisé.',
      sameTypeOnly: 'Seules les bobines du même type de matériau ({{type}}) peuvent prendre le relais.',
      noCandidates: 'Aucune bobine compatible — le secours doit être du même type de matériau ({{type}}).',
      confirm: 'Définir le secours',
      toastEngaged: 'Bobine de secours définie',
      toastEngagedNative: 'Secours activé — les bobines correspondent déjà.',
      toastReleased: 'Bobine de secours retirée',
      toastFailed: 'Impossible d\'activer la bobine de secours — l\'imprimante n\'a pas accepté la modification. Réessayez ou redémarrez l\'imprimante.',
      kDiffWarning: 'Le comportement d\'écoulement de cette bobine diffère légèrement ; la qualité d\'impression peut varier après le basculement.',
      badgePending: 'Activation du secours pour {{slot}}…',
      reassignTitle: 'Réaffecter le secours ?',
      reassignBody: 'Cette bobine sert actuellement de secours à une autre bobine de la même couleur. La réaffecter ?',
      reassignConfirm: 'Réaffecter',
    },
    activeJobSlot: {
  ...
  settings: {
    ...
    gcodeTemplateInsert: 'Insérer un modèle',
    gcodeTemplateOverwriteConfirm: 'Le G-code existant dans ce champ sera écrasé. Continuer ?',
  ...
  gcodeMotion: {
    title: 'Aperçu du mouvement G-code',
    previewButton: 'Prévisualiser le mouvement',
    play: 'Lecture',
    pause: 'Pause',
    scrubber: 'Chronologie',
    speed: 'Vitesse',
    frontOverhang: 'Débord avant',
    backOverhang: 'Débord arrière',
    corexyNoSwing: 'CoreXY : le plateau ne se déplace pas (Z uniquement)',
    unknownGeometry: 'Géométrie inconnue — imprimante générique 256 mm utilisée',
    accelDisclaimer: 'Les durées ignorent l\'accélération, le mouvement réel est plus lent.',
  },
  libraryTrash: {
    title: 'Corbeille',
