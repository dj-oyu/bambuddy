export default {
  ...
  printers: {
    ...
    filamentSpoof: {
      badgeTitle: 'Toma el relevo automáticamente cuando {{slot}} se agota',
      menuEngage: 'Definir respaldo de agotamiento',
      menuRelease: 'Quitar respaldo de agotamiento',
      modalTitle: 'Respaldo de agotamiento',
      primaryLabel: 'Respaldo para {{slot}}',
      modalHelp: 'Elige qué bobina toma el relevo automáticamente cuando esta ranura se agote.',
      sameTypeOnly: 'Solo bobinas del mismo tipo de material ({{type}}) pueden tomar el relevo.',
      noCandidates: 'No hay bobinas compatibles — el respaldo debe ser del mismo tipo de material ({{type}}).',
      confirm: 'Definir respaldo',
      toastEngaged: 'Respaldo de agotamiento definido',
      toastEngagedNative: 'Respaldo activado — las bobinas ya coinciden.',
      toastReleased: 'Respaldo de agotamiento quitado',
      toastFailed: 'No se pudo activar el respaldo de agotamiento — la impresora no aceptó el cambio. Inténtalo de nuevo o reinicia la impresora.',
      kDiffWarning: 'El comportamiento de flujo de esta bobina difiere ligeramente; la calidad de impresión puede variar tras el cambio.',
      badgePending: 'Activando respaldo de agotamiento para {{slot}}…',
      reassignTitle: '¿Reasignar respaldo?',
      reassignBody: 'Esta bobina respalda actualmente a otra bobina del mismo color. ¿Reasignarla?',
  ...
  settings: {
    ...
    gcodeTemplateInsert: 'Insertar plantilla',
    gcodeTemplateOverwriteConfirm: 'Se sobrescribirá el G-code existente en este campo. ¿Continuar?',
  ...
  gcodeMotion: {
    title: 'Vista previa de movimiento G-code',
    previewButton: 'Previsualizar movimiento',
    play: 'Reproducir',
    pause: 'Pausa',
    scrubber: 'Línea de tiempo',
    speed: 'Velocidad',
    frontOverhang: 'Saliente frontal',
    backOverhang: 'Saliente trasero',
    corexyNoSwing: 'CoreXY: la cama no se desplaza (solo Z)',
    unknownGeometry: 'Geometría desconocida — usando impresora genérica de 256 mm',
    accelDisclaimer: 'Las duraciones ignoran la aceleración; el movimiento real es más lento.',
  },
  libraryTrash: {
    title: 'Papelera',
