export default {
  ...
  printers: {
    ...
    filamentSpoof: {
      badgeTitle: 'Assume automaticamente quando {{slot}} acabar',
      menuEngage: 'Definir backup de fim de filamento',
      menuRelease: 'Remover backup de fim de filamento',
      modalTitle: 'Backup de fim de filamento',
      primaryLabel: 'Backup para {{slot}}',
      modalHelp: 'Escolha qual carretel assume automaticamente quando este slot acabar.',
      sameTypeOnly: 'Apenas carretéis do mesmo tipo de material ({{type}}) podem assumir.',
      noCandidates: 'Nenhum carretel compatível — o backup deve ser do mesmo tipo de material ({{type}}).',
      confirm: 'Definir backup',
      toastEngaged: 'Backup de fim de filamento definido',
      toastEngagedNative: 'Backup ativado — os carretéis já coincidem.',
      toastReleased: 'Backup de fim de filamento removido',
      toastFailed: 'Não foi possível ativar o backup de fim de filamento — a impressora não aceitou a alteração. Tente novamente ou reinicie a impressora.',
      kDiffWarning: 'O comportamento de fluxo deste carretel difere ligeiramente; a qualidade de impressão pode variar após a troca.',
      badgePending: 'Ativando backup de fim de filamento para {{slot}}…',
      reassignTitle: 'Reatribuir backup?',
      reassignBody: 'Este carretel atualmente faz backup de outro carretel da mesma cor. Reatribuir?',
      reassignConfirm: 'Reatribuir',
    },
    activeJobSlot: {
  ...
  settings: {
    ...
    gcodeTemplateInsert: 'Inserir modelo',
    gcodeTemplateOverwriteConfirm: 'O G-code existente neste campo será sobrescrito. Continuar?',
  ...
  gcodeMotion: {
    title: 'Prévia de movimento G-code',
    previewButton: 'Prever movimento',
    play: 'Reproduzir',
    pause: 'Pausar',
    scrubber: 'Linha do tempo',
    speed: 'Velocidade',
    frontOverhang: 'Saliência frontal',
    backOverhang: 'Saliência traseira',
    corexyNoSwing: 'CoreXY: a mesa não se desloca (apenas Z)',
    unknownGeometry: 'Geometria desconhecida — usando impressora genérica de 256 mm',
    accelDisclaimer: 'As durações ignoram a aceleração; o movimento real é mais lento.',
  },
  libraryTrash: {
    title: 'Lixeira',
