export default {
  ...
  settings: {
    ...
    gcodeTemplateInsert: 'Insert template',
    gcodeTemplateOverwriteConfirm: 'This will overwrite the existing G-code in this field. Continue?',
  ...
  gcodeMotion: {
    title: 'G-code Motion Preview',
    previewButton: 'Preview motion',
    play: 'Play',
    pause: 'Pause',
    scrubber: 'Timeline',
    speed: 'Speed',
    frontOverhang: 'Front overhang',
    backOverhang: 'Back overhang',
    corexyNoSwing: 'CoreXY: bed does not swing (Z only)',
    unknownGeometry: 'Geometry unknown — using generic 256mm printer',
    accelDisclaimer: 'Durations ignore acceleration, so real motion is slower than shown.',
  },
  libraryTrash: {
    title: 'Trash',
    headerButton: 'Trash',
